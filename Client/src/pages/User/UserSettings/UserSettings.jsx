...
export default function UserSettings() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const res = await axios.get("https://mini-chat-bot-ax9y.onrender.com/api/auth/user", {
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.put("https://mini-chat-bot-ax9y.onrender.com/api/auth/user", payload, {
        headers: { Authorization: `Bearer ${token}` },
      });
