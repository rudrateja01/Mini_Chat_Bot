...
export default function Settings() {
  ...
  useEffect(() => {
    const fetchAdmin = async () => {
      try {
        const res = await axios.get("https://mini-chat-bot-ax9y.onrender.com/api/auth/admin", {
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.put("https://mini-chat-bot-ax9y.onrender.com/api/auth/admin", payload, {
        headers: { Authorization: `Bearer ${token}` },
      });
      console.log(payload);
